...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICLR 2026</div><img src='https://heatingma.github.io/_pages/images/ICLR26_NExCO.png' alt="ml4lp" height="300"></div></div>
<div class='paper-box-text' markdown="1">
</div> -->
...
We propose **NExCO**, a masked diffusion framework that realizes adaptive solution
expansion as a native generative principle for neural combinatorial optimization. Our framework is
built on three key components: a CO-specific forward corruption that preserves sparsity and yields
semantic partial solutions, a time-agnostic GNN denoiser trained under optimization consistency,
and a Native Adaptive Expansion (NAE) inference strategy that progressively selects confident
variables under feasibility constraints.
</div>
</div>
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICML 2025</div><img src='https://heatingma.github.io/_pages/images/ICML25_PCL.png' alt="pcl" height="300"></div></div>
<div class='paper-box-text' markdown="1">
...
Runzhong Wang, Ziao Guo, Wenzheng Pan, **Jiale Ma**, Yikai Zhang, Nan Yang, Qi Liu, Longxuan Wei, Hanxue Zhang, Chang Liu, Zetian Jiang, Xiaokang Yang, Junchi Yan, *Journal of Machine Learning Research (**JMLR**), 2024*. <a href="https://github.com/Thinklab-SJTU/pygmtools" target="_blank"> <font color="#E15759"><b>[Code]</b> </font></a>
